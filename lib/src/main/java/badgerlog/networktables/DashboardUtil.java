...
/// Field utility class used for BadgerLog internally to manipulate [Field] values
public final class DashboardUtil {

    private DashboardUtil() {
    }

    /// Gets the value on the provided [Field]
    ///
    ...
    /// Sets the value on the provided [Field] to the specified value
    ///
    ...
    /// Verify that the provided [FieldInfo] matches the requirements for a field annotated with [Entry] or [MappingType]
    ///
