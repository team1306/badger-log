...
/// Factory class for all implementations of [Publisher]
public final class PublisherFactory {
    private PublisherFactory() {
    }

    /// Factory method to create a [Publisher] from existing mappings and implementations of Publisher
    ///
    ...
    /// @return a [Publisher] with the correct initialization
    /// @see ValuePublisher
